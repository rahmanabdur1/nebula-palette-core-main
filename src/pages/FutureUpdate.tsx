...
const FutureUpdate = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Advanced Trading */}
        <div className="glass-card rounded-xl p-6 border-2 border-green-500/40 bg-gradient-to-br from-green-500/10 via-emerald-500/5 to-teal-500/5 shadow-lg hover:shadow-green-500/20 hover:scale-105 transition-all duration-500 relative overflow-hidden group">
          ...
          <div className="text-transparent bg-gradient-to-r from-green-500 to-emerald-500 bg-clip-text font-semibold relative z-10">
            Coming Q2 2024
          </div>
        </div>
        ...
        {/* Multi-Chain Support */}
        <div className="glasscard rounded-xl p-6 border-2 border-green-500/40 bg-gradient-to-br from-green-500/10 via-emerald-500/5 to-teal-500/5 shadow-lg hover:shadow-green-500/20 hover:scale-105 transition-all duration-500 relative overflow-hidden group">
          <div className="absolute inset-0 bg-gradient-to-r from-green-500/5 to-emerald-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          <h3 className="text-transparent bg-gradient-to-r from-green-500 to-emerald-500 bg-clip-text text-xl font-bold mb-4 relative z-10">
            🌐 Multi-Chain Support
          </h3>
