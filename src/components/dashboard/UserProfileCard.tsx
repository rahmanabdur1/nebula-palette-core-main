...
export function UserProfileCard() {
  return (
    <div
      className="glass-card rounded-xl border-2 border-primary/30 bg-gradient-to-br from-primary/5 via-card to-accent/5 shadow-xl 
    ...
    >
      <div className="flex flex-col items-center space-y-4 sm:space-y-4 md:space-y-3">
        ...
        <div className="relative flex justify-center">
          <div className="absolute inset-0 rounded-full bg-gradient-primary p-[2px] sm:p-[3px] md:p-[4px] lg:p-[5px]">
        ...
        <div className="text-center space-y-1 sm:space-y-2 md:space-y-3">
          ...
          <div className="text-base sm:text-lg md:text-xl font-semibold text-foreground">
            Name : <span className="text-primary">RX T</span>
          </div>
          <div className="text-xs sm:text-sm md:text-base text-muted-foreground">
